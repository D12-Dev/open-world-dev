...
{
    public class OW_MPFactionRecruit : Window
    {
        ...
        private void OnAccept()
        {
            ...
            Packet AddFactionMemberPacket = new Packet("AddFactionMemberPacket", contents);
            Network.SendData(AddFactionMemberPacket);
