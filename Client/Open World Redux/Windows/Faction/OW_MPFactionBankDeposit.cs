...
{
    public class OW_MPFactionBankDeposit : Window
    {
        ...
        public OW_MPFactionBankDeposit()
        {
            ...
            FocusCache.bankDepositMenuInstance = this;
        }
        ...
        {
            Find.WindowStack.Add(new OW_MPConfirmBankDeposit());
        }
