...
{
    public class OW_MPFactionDisband : Window
    {
        ...
        {
            Packet DisbandFactionPacket = new Packet("DisbandFactionPacket");
            Network.SendData(DisbandFactionPacket);
            FocusCache.factionMenuInstance.Close();
            Close();
        }
