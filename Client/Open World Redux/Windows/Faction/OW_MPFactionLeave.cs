...
{
    public class OW_MPFactionLeave : Window
    {
        ...
        {
            Packet LeaveFactionPacket = new Packet("LeaveFactionPacket");
            Network.SendData(LeaveFactionPacket);
