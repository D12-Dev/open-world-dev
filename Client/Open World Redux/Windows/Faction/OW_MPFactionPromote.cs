...
{
    public class OW_MPFactionPromote : Window
    {
        ...
        private void OnAccept()
        {
            ...
            Packet PromoteFactionMemberPacket = new Packet("PromoteFactionMemberPacket", contents);
            Network.SendData(PromoteFactionMemberPacket);
