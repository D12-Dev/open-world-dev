...
{
    public class OW_MPFactionDemote : Window
    {
        ...
        private void OnAccept()
        {
            ...
            Packet DemoteFactionMemberPacket = new Packet("DemoteFactionMemberPacket", contents);
            Network.SendData(DemoteFactionMemberPacket);
