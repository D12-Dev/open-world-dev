...
{
    public class OW_MPFactionOnPlayer : Window
    {
        ...
        public OW_MPFactionOnPlayer()
        {
            FocusCache.factionOnPlayerInstance = this;
        ...
        private void HandleWindowContents(Rect rect)
        {
            ...
            if (inRecruit)
            {
                ...
                {
                    Find.WindowStack.Add(new OW_MPFactionRecruit());
                }
                ...
                {
                    Find.WindowStack.Add(new OW_MPFactionKick());
                }
            ...
            else if (inRank)
            {
                ...
                {
                    Find.WindowStack.Add(new OW_MPFactionPromote());
                }
                ...
                {
                    Find.WindowStack.Add(new OW_MPFactionDemote());
                }
