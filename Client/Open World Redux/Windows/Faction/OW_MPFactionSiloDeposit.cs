...
{
    public class OW_MPFactionSiloDeposit : Window
    {
        ...
        public OW_MPFactionSiloDeposit()
        {
            FocusCache.siloDepositMenuInstance = this;
        ...
        {
            Find.WindowStack.Add(new OW_MPConfirmDeposit());
        }
