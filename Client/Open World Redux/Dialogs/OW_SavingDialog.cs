...
{
    public class OW_SavingDialog : Window
    {
        public override Vector2 InitialSize => new Vector2(200f, 100f);

        private string windowTitle = "SAVE";
        private string windowDescription = "Saving file";

        public OW_SavingDialog()
        {
            FocusCache.saveWindowInstance = this;
